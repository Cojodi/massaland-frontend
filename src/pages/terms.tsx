    ...
    <Layout>
      <div className="container p-16 lg:py-48 mx-auto max-w-screen-md">
        ...
        <p>
          ...
          connection with the use of the website accessible at www.massa.land
        ...
        <p>
          The dApps accessible via massa.land are presented for informational
        ...
        <p>
          ...
          risk involved before engaging in crypto-related activities. Any loss
          of data, crypto assets or profit is your sole responsibility.
        </p>
