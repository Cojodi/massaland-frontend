    ...
    <Layout>
      <div className="container p-16 lg:py-48 mx-auto max-w-screen-md">
        ...
        <p className="my-4">
          ...
          towards you in the way we use that data. We must collect the
          information fairly and explain to you how we will use it. For ease of
          reading, we have divided this Privacy Policy into several sections:
        </p>
        ...
        <p className="my-4">
          ...
          other privacy notice or fair processing notice that we may provide at
          or around the time that we collect or process personal data about you
          so that you are fully aware of how and why we are using that data.
        </p>
        <p className="my-4">
          This Privacy Policy supplements other notices and legal documents and
          is not intended to override or replace them.
        </p>
        <p className="my-4">
        ...
        <p className="my-4">
          ...
          time to reflect changes to our business or changes in the law. Where
          these changes are significant we will endeavour to contact all of our
        ...
        <p className="my-4">
          ...
          your date of birth, or your contact details.
        </p>
        <p className="my-4">
          By law all organisations who process your personal data in the UK and
          Europe are obliged to process your personal data in certain ways and
          to ensure that you are given an appropriate amount of information
          about how they use it. You also have various rights to seek
          information from those organisations about how they are using your
          data, and to prevent them from processing it unlawfully. For more
          information about these rights, please see the ‘Your Rights’ section
        ...
        <p className="my-4">
          ...
          to): your IP address, email address and feedback.
        </p>
        <p className="my-4">
        ...
        <ul className="list-disc pl-8 my-8">
          ...
          <li className="mb-2">
            Where we need to do so in order to perform a contract we have
            entered into with you;
          </li>
          <li className="mb-2">
            Where it is necessary for our legitimate interests (or those of a
            third party) and your fundamental rights do not override those
            interests; and
          </li>
          <li className="mb-2">
        ...
        <p className="my-4">
          You will receive marketing messages from us if you have given us your
          consent to do so or if you have provided feedback and have not opted
          out of receiving marketing messages (and it is within our legal
          rights, when balanced against your rights and freedoms as an
          individual, to serve you with marketing).
        </p>
        <p className="my-4">
          To unsubscribe from marketing emails at any time, please click on the
          unsubscribe link at the bottom of any marketing email and update your
          account preferences. You may also contact us to inform us if you do
          not wish to receive any marketing materials from us.
        </p>
        ...
        <p className="my-4">
          Depending on how and why you provide us with your personal data, we
          may share it in the following ways:
        </p>

        <ul className="list-disc pl-8 my-8">
          <li className="mb-2">
            we may share your personal information with any member of our group
            where there is a valid and lawful reason to do so, which means our
            subsidiaries, our ultimate holding company and its subsidiaries, as
            defined in section 1159 of the UK Companies Act 2006;
          </li>
          <li className="mb-2">
            with selected third parties including business partners, suppliers
            and subcontractors for the performance of any contract we enter into
            with them or you (see &quot;Service Providers” below); or
          </li>
          <li className="mb-2">
        ...
        <ul className="list-disc pl-8 my-8">
          <li className="mb-2">
            ...
            might disclose your personal information to the prospective seller
          ...
          <li className="mb-2">
            ...
            order to enforce or apply our terms of service; or to protect the
            rights, property, or safety of our company, our customers, or
        ...
        <p className="my-4">
          ...
          the services we request, and we stipulate that they protect this
          information and do not use it for any other purpose. We take these
          relationships seriously and oblige all of our data processors to sign
        ...
        <p className="my-4">
          ...
          of that personal data and shall process it in accordance with their
          own privacy policy.
        </p>
        ...
        <p className="my-4">
          The Platform contains links to and from third party websites. Third
          party websites are out of our control and are not covered by this
          Privacy Policy. If you access third party sites using the links
          provided, the operators of these sites may collect information from
          you that could be used by them, in accordance with their own privacy
        ...
        <p className="my-4">
          We will hold your personal information on our systems only for as long
          as required to provide you with the products and services you have
          requested, including for the purposes of satisfying any legal,
        ...
        <p className="my-4">
          ...
          the United Kingdom (&quot;UK&quot;) and the European Economic Area
          (the &quot;EEA”).
        </p>
        <p className="my-4">
          Where we transfer your data to a service provider that is outside of
          the UK and/or the EEA we seek to ensure that appropriate safeguards
          are in place to make sure that your personal data is held securely and
          that your rights as a data subject are upheld. Transfers of personal
          data are either made:
        </p>

        <ul className="list-disc pl-8 my-8">
          <li className="mb-2">
            to a country recognised by the European Commission and/or the UK
            Secretary of State as providing an adequate level of protection; or
          </li>
          <li className="mb-2">
            ...
            the European Commission, the UK International Data Transfer clauses
            or by implementing other appropriate cross-border transfer solutions
        ...
        <p className="my-4">
          ...
          subject access request. You do not have to fill in a specific form to
        ...
        <p className="my-4">
          ...
          hold about you which you believe is incorrect or inaccurate. Please
          note that we may ask you to verify any new data that you provide to us
          and may take our own steps to check that the new data you have
          supplied us with is right.
        </p>
        <p className="my-4">
          You may also ask us to erase personal data that we control if you do
          not believe that we need to continue retaining it (you may have heard
          of this right described as the &quot;right to be forgotten”). Although
          we will do everything to respect your request and personal data it may
          not always be possible to erase all of your personal data as there may
          be legal requirements to keep certain personal data or technical
          limitations to the data we can delete; for example, we are not able to
          satisfy requests to erase records and information recorded on the
          blockchain, including, but not limited to, your chosen user name, your
          transaction history and your account balance.
        </p>
        <p className="my-4">
          There may also be legitimate interests in keeping certain data. If
          this is the case we will continue to process this data.
        </p>
        <p className="my-4">
          If erasure is not technically possible or we believe that we have a
          good legal reason to continue processing personal data that you ask us
          to erase we will tell you this and our reasoning at the time we
          respond to your request.
        </p>
        <p className="my-4">
          You can exercise this right at any time by writing to us using the
          contact details set out here and telling us that you are making a
          request to have your personal data rectified or erased and on what
          basis you are making that request. If you want us to replace
          inaccurate data with new data, you should tell us what that new data
          is. You do not have to fill in a specific form to make this kind of
          request.
        </p>
        ...
        <p className="my-4">
          ...
          interest you are entitled to ask us to stop processing it in that way
          if you feel that our continuing to do so impacts on your fundamental
          rights and freedoms or if you feel that those legitimate interests are
          not valid.
        </p>
        <p className="my-4">
          ...
          of it) but you wish for us to continue storing it in order to enable
          you to establish, exercise or defend legal claims.
        </p>
        <p className="my-4">
          Please note that if for any reason we believe that we have a good
          legal reason to continue processing personal data that you ask us to
          stop processing, we will tell you what that reason is, either at the
          time we first respond to your request or after we have had the
          opportunity to consider and investigate it.
        </p>
        <p className="my-4">
          You can exercise this right at any time by writing to us using the
          contact details set out here and telling us that you are making a
          request to have us stop processing the relevant aspect of your
          personal data and describing which of the above conditions you believe
          is relevant to that request. You do not have to fill in a specific
        ...
        <p className="my-4">
          ...
          you, which is processed by automated means, to a third party you may
          write to us and ask us to provide it to you in a commonly used
        ...
        <p className="my-4">
          You may object to processing of your personal data where we rely on
          legitimate interest for processing that personal data. We will comply
          with your request unless we have a compelling overriding legitimate
          interest for processing or we need to continue processing your
        ...
        <p className="my-4">
          For details on your rights to ask us to stop sending you various kinds
          of communications, please contact us.
        </p>
        ...
        <p className="my-4">
          ...
          of such processing that affects you.
        </p>
        ...
        <p className="my-4">
          Where we are relying on consent to process your personal data you may
          withdraw consent at any time. However, this will not affect the
        ...
        <p className="my-4">
          When you write to us making a request to exercise your rights we are
          entitled to ask you to prove that you are who you say you are. We may
          ask you to provide copies of relevant ID documents to help us to
          verify your identity.
        </p>
        <p className="my-4">
          It will help us to process your request if you clearly state which
          right you wish to exercise and, where relevant, why it is that you are
          exercising it. The clearer and more specific you can be, the faster
          and more efficiently we can deal with your request. If you do not
          provide us with sufficient information then we may delay actioning
